...
##### คำอธิบายเพิ่มเติม
> มีหน้าที่ : ตะกร้าเก็บตั๋ว เครื่องเล่นเดียว ต่อ 1 Rows และบอกว่าผู้ใช้กดใช้งาน Fastpass หรือไม่ <br>
...
|IsUse|boolean|status that tell is used yet|primary key default: false|
